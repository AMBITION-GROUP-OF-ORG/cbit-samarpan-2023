  ...
  return (
    ...
    <h1 className="modal-content w3-jumbo w3-right w3-button w3-border w3-border-blue  w3-ripple" onClick={close}>&times;</h1>
      ...
      <h1 className="w3-hover-text-orange w3-ripple">ABOUT</h1>
        ...
        <h1 className="w3-hover-text-orange w3-ripple" onClick={render_event}>EVENTS</h1>
        <h1 className="w3-hover-text-orange w3-ripple">Events Rules and Regulations</h1>
        <h1 className="w3-hover-text-orange w3-ripple" onClick={render_registration}>REGISTRATIONS</h1>
    ...
    <div className="w3-xlarge w3-container " style={{margin:"auto"}} >
    <img className="w3-small w3-left" src={Logo} alt="Logo"  />
    <button className="w3-right w3-button w3-border w3-border-red w3-hover-blue w3-padding-4" onClick={open}>
    <i className="material-icons ">menu</i></button>
    <div className=" w3-center w3-hide-small "><h1>C BYREGOWDA INSTITUTE OF TECHNOLOGY</h1></div>
    <div className=" w3-center w3-hide-large w3-hide-medium "><h1>CBIT</h1></div>
